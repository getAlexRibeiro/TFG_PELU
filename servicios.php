    ...
    <div class="container ">
      ...
      <div>
        ...
        <?php while($fila=mysqli_fetch_array($datos)) : ?>
          ...
          <a href="custom-login.php"><img class="img-fluid d-flex justify-content-between align-items-center" width="100%" height="100%" src="data:image/jpeg;base64,<?php echo  base64_encode($fila['imagen_servicio']) ?>" alt="<?php echo $fila['name_servicio'];?>"></a>
            <div class="card-body">

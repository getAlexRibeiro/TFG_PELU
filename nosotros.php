          ...
          <div class="col-lg-6 order-lg-2 mb-3 mb-lg-0">
            <div class="d-flex align-items-center p-5 p-xl-6 bg-gray-100 h-100">
              <div>
                ...
                <h1 class="display-3 text-serif fw-bold mb-5">Pelu de María</h1>
                <div class="row">
                  <div class="col-xl-6">
                ...
                <div class="row">
                  <div class="col-xl-6">
                    <h6 class="text-uppercase mb-4"></h6>
                    <p class="text-lg text-muted mb-4 mb-xl-0"><br></p>
                  </div>
                  <div class="col-xl-6">
                    <h6 class="text-uppercase mb-4"></h6>
                    <p class="text-lg text-muted mb-0"><br></p>
                  </div>
                </div>
              </div>
            </div>

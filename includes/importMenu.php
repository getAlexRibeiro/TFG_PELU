...
<nav class="navbar navbar-expand-lg bg-transparent navbar-light navbar-airy bg-fixed-white">
        <div class="container-fluid">  
          <!-- Navbar Header  --><a class="navbar-brand" href="index.php"><img class="nav-brand-logo" src="assets/logos/logo-peluqueria.jpeg" alt=" Famoso Barber" style="width: 90px;"></a>
          ...
          <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <li class="nav-item"><a class="nav-link" href="index.php">Inicio</a>
              ...
              <li class="nav-item"><a class="nav-link" href="nosotros.php"> Famoso Barber</a>
              </li>
              <!-- Megamenu-->

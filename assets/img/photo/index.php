  ...
  <!-- IMPORTS HEADER END -->
   ...
   <section>
      ...
      <div class="owl-carousel owl-theme owl-dots-modern home-slider">
        <div class="item d-flex align-items-center" style="background: #f8d5cf;"><img class="bg-image" src="assets/img/photo/slider-principal.png" alt="">
        ...
        <div class="item d-flex align-items-center bg-dark dark-overlay"><img  class="bg-image" src="assets/img/photo/slider-principal-2.png" alt="">
          <div class="container py-6">
            <div class="row">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-5">
            ...
            <h2 class="mb-4">Pelu de Maria</h2>
          ...
          <div class="col-lg-6 ms-lg-auto">
            <div class="row">
              <div class="col-sm-6 mb-4">
                <h4>1995</h4>
                <p class="text-muted">Apertura de la peluquería después de varios trabajos en otros establecimientos de Colmenar Viejo</p>
              </div>
              <div class="col-sm-6 mb-4">
                <h4>2000</h4>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6 d-flex align-items-md-stretch mb-4 mb-md-0">
            <div class="d-flex align-items-center text-white dark-overlay w-100 text-center py-6 py-md-0" style="background: center center url(img/photo/nordwood-themes-481980-unsplash-square.jpg) no-repeat; background-size: cover;"><a class="tile-link" href="category.html"> </a>
          ...
          <div class="col-md-6">
            <div class="card border-0 text-white text-center mb-4 dark-overlay"> <img class="card-img" src="assets/img/photo/malvestida-magazine-458585-unsplash.jpg" alt="Ladies"><a class="tile-link" href="category.html"> </a>
            ...
            <div class="card border-0 text-white text-center  dark-overlay"> <img class="card-img" src="assets/img/photo/heather-schwartz-528936-unsplash.jpg" alt="Accessories"><a class="tile-link" href="category.html"> </a>
              <div class="card-img-overlay d-flex align-items-center">
                <div class="text-center w-100 overlay-content">
